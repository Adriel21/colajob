...
<main class="container-md-fluid marketing" >
    ...
    <section class="hv-section-hero">
        <section class="container row my-5 py-3 m-auto flex-column-reverse flex-lg-row" >
            ...
            <!-- img -->
            <picture class="col-xl-6 col-lg-6 col-md-12 text-lg-end text-center pt-1 my-5">
            <img class="img-responsive m-auto" src="{{ asset('img/home/3d-cloud-storage.png') }}" alt="" >
            </picture>
        </section>
    </section>
    <!-- Primeiro finalizado -->
